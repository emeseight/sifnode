...
func (_Mocks *MocksCaller) Decimals(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
...
//
// Solidity: function decimals() view returns(uint16)
func (_Mocks *MocksSession) Decimals() (uint16, error) {
...
//
// Solidity: function decimals() view returns(uint16)
func (_Mocks *MocksCallerSession) Decimals() (uint16, error) {
	return _Mocks.Contract.Decimals(&_Mocks.CallOpts)
}
...
func (_Mocks *MocksFilterer) FilterApproval(opts *bind.FilterOpts) (*MocksApprovalIterator, error) {

	logs, sub, err := _Mocks.contract.FilterLogs(opts, "Approval")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Approval(address owner, address spender, uint256 amount)
func (_Mocks *MocksFilterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *MocksApproval) (event.Subscription, error) {

	logs, sub, err := _Mocks.contract.WatchLogs(opts, "Approval")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Transfer(address from, address to, uint256 tokens)
func (_Mocks *MocksFilterer) FilterTransfer(opts *bind.FilterOpts) (*MocksTransferIterator, error) {

	logs, sub, err := _Mocks.contract.FilterLogs(opts, "Transfer")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Transfer(address from, address to, uint256 tokens)
func (_Mocks *MocksFilterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *MocksTransfer) (event.Subscription, error) {

	logs, sub, err := _Mocks.contract.WatchLogs(opts, "Transfer")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
